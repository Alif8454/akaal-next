    ...
    <>
      ...
      <nav className="navbar navbar-expand-lg">
        <div className="container-fluid">
          ...
          >
            <Image
              src="/img/icon-gradientbg-rgb.png" // Path relatif ke folder public
              alt="Logo"
              width="24"
              height="24"
      ...
      <main>{children}</main> {/* Ini akan berisi konten halaman individual */}
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <div className="footer-column">
            <Image
              src="/img/logo-fullcolor-negative-rgb.svg" // Path relatif ke folder public
              alt="Akaal"
